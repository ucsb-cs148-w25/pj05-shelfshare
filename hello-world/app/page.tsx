    ...
    >
      ...
      <div className="flex flex-col items-center mt-12 w-full">
        <div className="relative w-full">
          {/* Read Next Text */}
          <div
            className="font-bold items-center text-3xl"
          ...
          {/* Shelf Background */}
          <div
            className="relative w-[1030px] h-[300px] mt-8 mx-auto"
      ...
      <div className="flex justify-center mt-12 space-x-20">
        ...
        <div
          ...
          style={{ backgroundColor: '#DFDDCE', width: '350px' }}
        >
          <h3
        ...
        <div className="flex flex-col space-y-4">
          <div
            ...
            style={{ backgroundColor: '#DFDDCE', width: '500px' }}
          >
            <div className="w-[100px] h-[150px] bg-[#3D2F2A] rounded-lg"></div>
            <div>
            <h3 className="text-lg font-bold" style={{ color: '#3D2F2A' }}>
                Title
              </h3>
              <p className="text-sm" style={{ color: '#3D2F2A' }}>
                Author
              </p>
              <p className="text-sm" style={{ color: '#3D2F2A' }}>★★★★★</p>
              <p className="text-sm mt-2" style={{ color: '#3D2F2A' }}>
                Book Review
              </p>
            </div>
          </div>
